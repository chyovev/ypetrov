 ...
 */
class Config extends \Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Config' . "\0" . 'id', '' . "\0" . 'Config' . "\0" . 'setting', '' . "\0" . 'Config' . "\0" . 'value', '' . "\0" . 'Config' . "\0" . 'modifiedAt'];
        }
