 ...
 */
class TextPage extends \TextPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TextPage' . "\0" . 'id', '' . "\0" . 'TextPage' . "\0" . 'title', '' . "\0" . 'TextPage' . "\0" . 'shortTitle', '' . "\0" . 'TextPage' . "\0" . 'slug', '' . "\0" . 'TextPage' . "\0" . 'body', '' . "\0" . 'TextPage' . "\0" . 'readCount', '' . "\0" . 'TextPage' . "\0" . 'createdAt', '' . "\0" . 'TextPage' . "\0" . 'modifiedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextPage $proxy) {
