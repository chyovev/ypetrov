            ...
            <div class="card">
                <div class="card-title">
                    <h3 class="text-primary">
                        ...
                        <x-admin.total-results :items="$essays" />
                        <div class="dt-buttons float-right ml-2">
                            ...
                            <a class="btn btn-warning reorder" href="{{ route('admin.reorder', ['table' => 'essays'])}}"><i class="fa fa-align-left"></i> {{ __('global.reorder') }}</a>
                        </div>
                        <x-admin.search />
                    </h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive m-t-40">
                        ...
                        <x-admin.pagination :data="$essays" />
                    </div>
                </div>
            </div>
        </div>
