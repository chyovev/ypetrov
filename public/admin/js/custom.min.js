...
let App = {
    ...
    initWysiwyg: function() {
        $('.textarea_editor').wysihtml5({
            ...
            "image": false, // button to insert image
        });
    },
    ...
    ///////////////////////////////////////////////////////////////////////////
    /**
     * If the reordering POST request is successful, a new informative
     * pop-up window should be opened up to notify the user about it.
     * Once *that* pop-up is closed, the page should be reloaded
     * so that the newly ordered data gets shown.
     */
