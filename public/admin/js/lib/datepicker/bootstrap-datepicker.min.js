            ...
            return (
                ...
                this.range &&
                    (b > this.range[0] &&
                        ...
                        c.push('range'),
                    a.inArray(b.valueOf(), this.range) !== -1 &&
                        c.push('selected'),
            ...
            if (!isNaN(g) && !isNaN(h)) {
                this.picker
                    ...
                    this.picker
                        ...
                        .css(
                            'display',
                            this.o.clearBtn === !0 ? 'table-cell' : 'none'
                        ),
                    this.picker
                ...
                for (var u, v, w = []; p.valueOf() < t; ) {
                    if (
                        ((u = p.getUTCDay()),
                        u === this.o.weekStart &&
                            (w.push('<tr>'), this.o.calendarWeeks))
                    ) {
                        var x = new Date(
                                +p + ((this.o.weekStart - u - 7) % 7) * 864e5
                            ),
                            y = new Date(
                                Number(x) + ((11 - x.getUTCDay()) % 7) * 864e5
                            ),
                            z = new Date(
