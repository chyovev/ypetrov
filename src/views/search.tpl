            ...
            <div class="results">
                ...
                {foreach $results as $bookId => $group}
                    ...
                    <div class="book-result-wrapper">
                        <a href="{url params=['controller' => 'books', 'action' => 'view', 'book' => $book['slug']]}" class="book-title desktop-stickable">{escape($book['title'])} ({$book['published_year']})</a>
                        <div class="poem-result-wrapper">

                    {foreach $group as $item}
                            <div class="poem-result">
                                <a href="{url params=['controller' => 'poems', 'action' => 'view', 'book' => $book['slug'], 'poem' => $item['slug']]}">{outlineElementsInText($searchWords, escape($item['title']))}</a>
