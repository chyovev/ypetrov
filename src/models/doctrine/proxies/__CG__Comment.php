 ...
 */
class Comment extends \Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Comment' . "\0" . 'id', '' . "\0" . 'Comment' . "\0" . 'entityClass', '' . "\0" . 'Comment' . "\0" . 'entityId', '' . "\0" . 'Comment' . "\0" . 'username', '' . "\0" . 'Comment' . "\0" . 'body', '' . "\0" . 'Comment' . "\0" . 'ip', '' . "\0" . 'Comment' . "\0" . 'createdAt', '' . "\0" . 'Comment' . "\0" . 'entity'];
        }
     ...
     * {@inheritDoc}
     */
    public function setEntityClass(string $entityClass): \Comment
    {
     ...
     * {@inheritDoc}
     */
    public function setEntityId(int $entityId): \Comment
    {
     ...
     * {@inheritDoc}
     */
    public function setIp(string $ip = NULL): \Comment
    {
