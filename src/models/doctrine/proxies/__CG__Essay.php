 ...
 */
class Essay extends \Essay implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Essay' . "\0" . 'id', '' . "\0" . 'Essay' . "\0" . 'active', '' . "\0" . 'Essay' . "\0" . 'title', '' . "\0" . 'Essay' . "\0" . 'shortTitle', '' . "\0" . 'Essay' . "\0" . 'slug', '' . "\0" . 'Essay' . "\0" . 'body', '' . "\0" . 'Essay' . "\0" . 'readCount', '' . "\0" . 'Essay' . "\0" . 'ord', '' . "\0" . 'Essay' . "\0" . 'createdAt', '' . "\0" . 'Essay' . "\0" . 'modifiedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Essay $proxy) {
