...
class CommentSubscriber implements EventSubscriber {
    ...
    private function getBookLink(int $id): array {
        ...
        $url        = Router::url(['controller' => 'books', 'action' => 'view', 'book' => $item['slug']], true);
    ...
    private function getPoemLink(int $id): array {
        ...
        if (isset($contents[0])) {
            ...
            $url        = Router::url(['controller' => 'poems', 'action' => 'view', 'book' => $bookItem['slug'], 'poem' => $item['slug']], true);
    ...
    private function getVideoLink(int $id): array {
        ...
        $entity     = $repository->findOneBy(['id' => $id]);
        $item       = $entity->getDetails();
        $url        = Router::url(['controller' => 'videos', 'action' => 'view', 'video' => $item['slug']], true);
    ...
    private function getArticleLink(int $id): array {
        ...
        $entity     = $repository->findOneBy(['id' => $id]);
        $item       = $entity->getDetails();
        $url        = Router::url(['controller' => 'press', 'action' => 'view', 'press' => $item['slug']], true);
    ...
    private function getEssayLink(int $id): array {
        ...
        $entity     = $repository->findOneBy(['id' => $id]);
        $item       = $entity->getDetails();
        $url        = Router::url(['controller' => 'essays', 'action' => 'view', 'essay' => $item['slug']], true);
    ...
    private function getTextPageLink(int $id): array {
        ...
        $entity     = $repository->findOneBy(['id' => $id]);
        $item       = $entity->getDetails();
        $url        = Router::url(['controller' => 'textpages', 'action' => 'view', 'textpage' => $item['slug']], true);
